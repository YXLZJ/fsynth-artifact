...
public class INIOracleTestsIncorrect extends INIOracleTests {
    ...
    /**
     * This unit test is extremely important for INI files, since they cannot be repaired by erepair if this test fails:
     *
     ...
     * Very important for erepair to work properly!
     *
     * @param subjects Subject
     */
    @ParameterizedTest(name = "{index}: ({0})")
     ...
     * Test that incomplete lines with an appended comment are actually classified as inCORRECT -
     * Very important for erepair to work properly!
     * This test is a real-world example where erepair failed to repair because of misclassification
     *
     * @param subjects Subject
     */
    @ParameterizedTest(name = "{index}: ({0})")
